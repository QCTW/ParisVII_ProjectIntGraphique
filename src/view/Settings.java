...
public class Settings
{
	...
	public static final int CONTENT_AREA_WIDTH = 1024;
	public static final int CONTENT_AREA_HEIGHT = 768;
	...
	public static final Color ALGO_FINDSMALLEST_COLOR = Color.PINK;
	public static final Color ALGO_SMALLEST_COLOR = Color.DEEPPINK;
	...
	public static final String IMAGE_PLAY_MODE = "../resource/ic_ondemand_video_48pt_3x.png";
	public static final String IMAGE_EDIT_MODE = "../resource/ic_border_color_48pt_3x.png";
